...
|------|-------------|-----------------|--------|---------|---------|
| 12-01 | Replace raw buttons with design system, fix lint errors | components/PackingList.tsx, MealPlan.tsx, SettingsClient.tsx, + 5 more | unclaimed | — | — |
| 12-02 | SW cache for trip routes, pipe tripCoords to LeavingNowButton | public/sw.js, depart/page.tsx, DepartureChecklistClient.tsx | unclaimed | — | — |
