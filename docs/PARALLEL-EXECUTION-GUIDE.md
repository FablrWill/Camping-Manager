...
| 12-02 | SW cache for trip routes, pipe tripCoords to LeavingNowButton | public/sw.js, depart/page.tsx, DepartureChecklistClient.tsx | in-progress | tender-sinoussi | Laptop |
| 12-03 | Implement test stubs, remove low-value test | tests/usage-tracking.test.ts, tests/trip-summary.test.ts | in-progress | heuristic-tereshkova | Laptop |
