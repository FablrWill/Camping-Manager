...
export async function PATCH(
  ...
  try {
    ...
    // Wrap read-modify-write in $transaction to prevent race conditions on rapid sequential taps
    await prisma.$transaction(async (tx) => {
      ...
      // Use immutable map to produce updated items array (per coding-style immutability rules)
